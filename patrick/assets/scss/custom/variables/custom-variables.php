...
$variables = new CssHelper([], "patrick-custom-variables", false);
...
$variables->addCssRule(
    "footer",
    array(
        "background" => getBgColor(str_replace(")","",str_replace("var(--clr-","",get_field('footer_bg_color', 'options'))), get_field('footer_bg_color_is_gradient', 'options'), "180deg")
    )
);

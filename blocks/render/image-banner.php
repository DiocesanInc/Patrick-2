        ...
        <div class="banner-wrap" data-aos="fade-up">
            ...
            <div class="buttons">
                <?php while (have_rows('image_banner_buttons')) : the_row();
                        $color = "has-" . get_sub_field("color") . "background-color";

                        echo acfLink(get_sub_field('button'), "the-button $color");
                    endwhile; ?>
            </div>
            <?php endif; ?>
        </div>

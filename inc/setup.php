...
if (!function_exists('patrick_setup')) :
    ...
    function patrick_setup()
    {
        ...
        register_nav_menus(
            array(
                'menu-1' => esc_html__('Primary', 'patrick'),
                'footer-quicklinks' => esc_html__('Footer Quicklinks', 'patrick'),
            )
        );
        ...
        add_theme_support(
            'custom-background',
            apply_filters(
                'patrick_custom_background_args',
                array(
 ...
 */
function patrick_content_width()
{
    $GLOBALS['content_width'] = apply_filters('patrick_content_width', 640);
}
add_action('after_setup_theme', 'patrick_content_width', 0);
...
function patrick_widgets_init()
{
    register_sidebar(
        array(
            'name'          => esc_html__('Sidebar', 'patrick'),
            'id'            => 'sidebar-1',
            'description'   => esc_html__('Add widgets here.', 'patrick'),
